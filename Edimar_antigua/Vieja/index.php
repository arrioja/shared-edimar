      ...
      <tr>
        ...
        <td width="74%" valign="top"><table width="98%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="28%" align="center" class="Borde_Punteado"><?php if($permiso=='1'){?>
			<A href="<?php echo "modedimar.php?".$UR."&Id=".$_GET["Id"]."&Usr=".$usr?>">
			<img border="0" src="Imagenes/mod.jpg" width="21" height="23"> Modificar</A><?php }?></td>
          </tr>
          <tr>
            <td colspan="2" align="center" class="Titulo"> <br><?php  echo $rowEdimar['Titulo']; ?>
      </td>
            </tr>
          <tr>
            <td colspan="2"><br>
                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="59%" class="Parrafo"><?php echo  $rowEdimar['Parrafo_I']; ?> </td>
                    <td width="41%" align="center"><img src="Imagenes/entraga-Edimar.jpg" width="227" height="172"> <br>
                    </td>
                  </tr>
            <td colspan="2" class="Parrafo"><?php echo  $rowEdimar['Parrafo_II']; ?> </td>
            <tr> </tr>
                </table>
