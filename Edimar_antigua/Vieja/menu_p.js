...
function mmLoadMenus(id, usr) {
	...
	var consult='Consultas y Prestamos';var fico='Ficoteca y Herbario';
  ...
  if (id=='_Ing'){
	  ...
	  trabajo ='Supplies of Work';  pasan='Pasantías available'; tesis='Thesis proposals'; alimento='Quality of Foods'; agua='Quality of Waters';
  ...
  mm_menu_0715190740_0.addMenuItem(quienes,"window.open('index.php?"+UR+"Id="+id+"&Usr="+usr+"', '_self');");
  ...
  mm_menu_0715190740_0.addMenuItem("Edimar&nbsp;360º","location='index.php?"+UR+"Id="+id+"&Usr="+usr+"'");
...
window.mm_menu_0715193427_0 = new Menu("root",121,17,"Verdana",11,"#000000","#FFFFFF","#E2F7FC","#3385B5","left","middle",3,0,1000,-5,7,true,true,true,0,true,true);
  mm_menu_0715193427_0.addMenuItem(noticias,"window.open('index.php?"+UR+"Id="+id+"&Usr="+usr+"', '_self');");
  mm_menu_0715193427_0.addMenuItem(eventos,"location='index.php?"+UR+"Id="+id+"&Usr="+usr+"'");
  ...
  mm_menu_0715193533_0.addMenuItem(trabajo);
  mm_menu_0715193533_0.addMenuItem(tesis);
  mm_menu_0715193533_0.addMenuItem(pasan);
  ...
  mm_menu_0715202127_0.addMenuItem(alimento);
  mm_menu_0715202127_0.addMenuItem(agua);
   ...
   mm_menu_0715202127_0.menuBorderBgColor='#85AD95';
    ...
    window.mm_menu_0715202233_0 = new Menu("root",179,17,"Verdana",11,"#000000","#FFFFFF","#FCE0E8","#E96072","left","middle",3,0,1000,-5,7,true,true,true,0,true,true);
  mm_menu_0715202233_0.addMenuItem(intro);
  mm_menu_0715202233_0.addMenuItem(organi);
  mm_menu_0715202233_0.addMenuItem(consult);
  mm_menu_0715202233_0.addMenuItem(fico);
   ...
   mm_menu_0715202233_0.menuBorderBgColor='#E96072';
...
function menuP(id,usr){
    ...
    document.write('<tr><td align="center"><p><a href="#" onMouseOut="MM_swapImgRestore();MM_startTimeout();" onMouseOver="MM_swapImage(');
    document.write("'acerkD','','Imagenes/acekD_II"+id+".jpg',1);MM_showMenu(window.mm_menu_0715190740_0,104,0,null,'acerkD')");
    document.write('"><img src="Imagenes/acekD_I'+id+'.jpg" name="acerkD" width="104" height="21" border="0"></a></p></td>');
    ...
    document.write('<tr><td><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage(');
    ...
    document.write('<a href="index.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage(');
    ...
    document.write('<a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage(');
    ...
    document.write('</table><br><table width="100%"  border="0" cellspacing="0" cellpadding="0">');
    document.write('<tr><td><img src="Imagenes/Collec.jpg" width="118" height="33"></td>');
    document.write('</tr><tr><td height="40" align="center" bgcolor="#E96072">');
    ...
    document.write('<tr><td height="30" bgcolor="#E96072"><img src="Imagenes/sesion.jpg" width="118" height="20"></td>'); 
    document.write('</tr><tr><td bgcolor="#E96072"><table width="100%"  border="0" cellspacing="0" cellpadding="0">');
    ...
    document.write('<td width="118" height="31" align="right" background="Imagenes/Collec_Inf.jpg"><input type="submit" name="Submit2" value="Entrar">');
    document.write('&nbsp;&nbsp;</td></tr></form></table></td></tr></table><p>&nbsp;</p><p>&nbsp;</p></td>');
