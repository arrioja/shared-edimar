          ...
          <tr>
            <td><br>
				...
				<form name="form2" method="post" action="">
                  ...
                  <tr>
                    <td height="40" colspan="2" class="Titulo_II">*Primer P&aacute;rrafo (<em>Maximo 7 lineas </em>): </td>
                  </tr>
                  <tr>
                    <td colspan="2" class="Parrafo"><textarea name="Parraf1" cols="80" rows="7" id="Parraf1"><?php echo $Parraf1; ?>
                      </textarea>                       </td>
                    </tr>
                  <tr>
                    <td height="40" colspan="2"  class="Titulo_II">*Segundo P&aacute;rrafo:</td>
                  <tr>
