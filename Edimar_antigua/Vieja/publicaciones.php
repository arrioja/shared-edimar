...
$id='';$usr='0'; $permiso=''; ; $Nick='';
 ...
 $query_reg_most = "SELECT publicacion.Cod, Nombre as Dpto, Descrip, Dir FROM publicacion inner join
                   departamento on Dpto=departamento.Cod and publicacion.Idioma='".$id."' and publicacion.Tipo='".$_GET["T"]."'
				    group by Cod,Dpto";
          ...
          <tr>
            <td><br><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
             <?php $dpto=''; $i=1;
              ...
              <tr>
                <td width="92%" height="45" class="Parrafo_II"><?php echo $rowEdimar["Descrip"];?></td>
                <td width="8%" align="center" class="borde_rayado"><?php if ($rowEdimar["Dir"]!=''){?><a href="<?php echo "Publicaciones/".$rowEdimar["Dir"];?>"><img border="0" name="<?php echo "pdf".$i;?>" src="Imagenes/pdf.gif" width="35" height="33"></a><?php }else{?>&nbsp;<?php }?></td>
              </tr>
              <tr>
                <td height="20" class="Parrafo_II" >&nbsp;</td>
                <td class="borde_rayado">&nbsp;</td>
              </tr>
			  <?php $i++;}?>
            </table>              
            <br>               </td>
