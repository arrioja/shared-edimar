    ...
    <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<tr>
            ...
            <td width="25%" align="center" class="Borde_Punteado"><?php if($permiso=='1'){?>
          ...
          <tr>
            <td colspan="2"><br>
                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="57%" class="Parrafo"><?php echo  utf8_decode($rowEdimar['Resena']); ?> </td>
                    ...
                    <td width="41%" align="center" valign="top" class="borde_rayado"><img src="<?php echo "Imagenes/".$rowEdimar["Imagen"]?>" width="241" height="223"> <br>
                        <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            <td class="Parrafo"><?php echo  utf8_decode($rowEdimar['Mision']); ?></td>
                          </tr>
                          <tr>
                            <td height="50" align="left" class="Titulo_II">Visi&oacute;n</td>
                          </tr>
                          <tr class="Parrafo">
                            <td><?php echo  utf8_decode($rowEdimar['Vision']); ?></td>
                          </tr>
                      </table></td>
                  </tr>
                  <tr> </tr>
