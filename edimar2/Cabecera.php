...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
			<td height="46" align="right" background="Imagenes/Linea_R.jpg"><a href="<?php echo "index.php?".$UR."&Id=_E&Usr=".$usr;?>" target="_parent"><?php if ($_GET["Id"]=='_E'){echo "<strong>Español</strong>"; }else{ echo "Español";}?></a> /<a href="<?php echo "index.php?".$UR."&Id=_Ing&Usr=".$usr;?>" target="_parent"> <?php if ($_GET["Id"]=='_Ing'){echo "<strong>Ingles</strong>"; }else{ echo "Ingles";}?></a> </td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="363" align="center" background="Imagenes/Centro_Inf_II.jpg"><table width="95%" height="35" cellpadding="0" cellspacing="0"  class="Borde_Punteado">
            <form action="<?php echo "Busqueda.php?".$UR."&Id=".$_GET["Id"]."&Usr=".$usr;?>" method="post" name="form1" target="_parent">
              <tr>
                <td width="41%" class="letra_Busq"><div align="right">Busqueda /Search: &nbsp;</div></td>
                <td width="43%"><input name="busqueda" type="text" id="busqueda" />
                </td>
