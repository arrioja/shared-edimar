                ...
                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="53%" valign="top" class="Parrafo"><table width="90%"  border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td><a href="<?php echo "pelicula.php?".$UR."&Id=_E&Usr=".$usr."&Pel=Direccion.swf&Cad=Dirección";?>" target="movies">Direcci&oacute;n</a></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td><a href="<?php echo "pelicula.php?".$UR."&Id=_E&Usr=".$usr."&Pel=Microbiologia.swf&Cad=Microbiología";?>" target="movies">Microbiolog&iacute;a</a></td>
                      </tr>
                      <tr>
					  ...
					  <tr>
                        <td><a href="<?php echo "pelicula.php?".$UR."&Id=_E&Usr=".$usr."&Pel=BiologiaP.swf&Cad=Biología Pesquera";?>" target="movies">Biología Pesquera </a></td>
                      </tr>
					  <tr>
