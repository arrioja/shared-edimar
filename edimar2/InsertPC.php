...
if (isset($_POST['boton']))  {
  ...
  if  ($_POST['boton']=="Aceptar") {
    //modificar  noticias
	if (trim($_POST['Descrip'])!=""){$err=0;
	 mysql_query("BEGIN",$conexion); 
	
	    $insertvend = sprintf("INSERT INTO proy_consult (Descrip, Idioma,Tipo) VALUES (%s, %s, %s)",
...
/* $query_reg_most = "SELECT Titulo FROM  edimar where Idioma='".$id."'";
 ...
 if ($_GET["T"]=='P'){  $tipo='Proyecto'; }else{$tipo='Servicio';}
    ...
    <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="81%" valign="top"><table width="98%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="center" class="Titulo"> <br> <?php  echo  "CONSULTORIA AMBIENTAL" ?>      </td>
          </tr>
          <tr>
            <td ><br>
              <br>
