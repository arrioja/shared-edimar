  ...
  <tr>
    <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="81%" valign="top"><iframe name="galeria" frameborder="0"  width="100%" height="800" src="<?php echo "galeria.php?".$UR."&Id=".$_GET["Id"]."&Usr=".$_GET["Usr"]."&permiso=".$_GET["permiso"]?>" scrolling="no"></iframe></td>
