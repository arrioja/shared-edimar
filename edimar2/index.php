  ...
  <tr>
    <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="81%" valign="top"><br><table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
          ...
          <tr>
            <td colspan="2" align="left"><table width="350" height="40" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td valign="bottom" class="Titulo style1">N&uacute;mero de Visitas:</td>
                <td><iframe frameborder="0" src="contador.php" width="200" height="30" scrolling="no"></iframe></td>
              </tr>
              <tr>
                <td valign="bottom" class="Titulo style1">&Uacute;ltima Actualizaci&oacute;n: </td>
                <td height="30" valign="bottom"><?php  echo $rowEdimar['FechaA']; ?></td>
              </tr>
            </table></td>
            <td >&nbsp;</td>
          </tr>
