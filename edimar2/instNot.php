...
if (isset($_POST['boton']))  {
  ...
  if  ($_POST['boton']=="Aceptar") {
	...
	mysql_query("BEGIN",$conexion);
	 if ($_GET["Op"]=='M'){
       $insertvend = sprintf("update noticia, edimar set noticia.Descrip=%s, noticia.Titulo=%s, noticia.Resumen=%s, edimar.FechaA=%s
	                          where edimar.Idioma=noticia.Idioma and noticia.Cod=%s",
