...
if (isset($_POST['boton']))  {
  ...
  if  ($_POST['boton']=="Aceptar") {
       ...
       $insertvend = sprintf("update departamento, edimar set departamento.Educacion=%s, departamento.FechaA=%s, edimar.FechaA=%s 
 ...
 $query_reg_most = "SELECT Cod, Educacion, Nombre FROM departamento where Cod='".$_GET["Cod"]."' and Idioma='".$id."'";
 $reg_most = mysql_query($query_reg_most, $conexion) or die(mysql_error());
 $rowEdimar = mysql_fetch_assoc($reg_most);
 $totalRows_reg_most = mysql_num_rows($reg_most);
  $Educ=$rowEdimar['Educacion']; 
}//del if isset
		...
		<tr>
          ...
          <tr>
            <td colspan="2" align="left" class="Titulo"> <br>
                <?php  echo "Educación -> ".$rowEdimar['Nombre']; ?>            </td>
          </tr>
          <tr>
            <td colspan="2"><br>
                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
