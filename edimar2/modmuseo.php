...
if (isset($_POST['boton']))  {
  ...
  if  ($_POST['boton']=="Aceptar") {
    //modificar  noticias
	if ((trim($_POST['Titulo'])!="")&&(trim($_POST['Parraf1'])!="")&&(trim($_POST['Parraf2'])!="")){$err=0;
	mysql_query("BEGIN",$conexion); 
       $insertvend = sprintf("update museo, edimar set museo.Titulo=%s,museo.Descrip=%s,Divulgacion=%s, FechaA=%s  where museo.Cod=%s and museo.Idioma=edimar.Idioma",
  ...
  if ($vacios==0){header("Location: museo.php?".$UR."&Id=".$_GET["Id"]."&Usr=".$_GET["Usr"]);}
}else{
          ...
          <tr>
            <td><br>
				...
				<form name="form2" method="post" action="">
                  <tr>
                    <td height="20" colspan="2" class="Titulo_II">*T&iacute;tulo:</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td height="40" colspan="2"  class="Titulo_II">*Divulgaci&oacute;n:</td>
                  <tr>
