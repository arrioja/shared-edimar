...
if (isset($_POST['boton']))  {
  ...
  if  ($_POST['boton']=="Guardar Cambios") {
	...
	{ 
		...
		$nom_arch=$_FILES["Foto"]["name"];
         ...
         $insertvend = sprintf("update personal, edimar, departamento set personal.Nombre=%s,Apellido=%s,Cargo=%s,Correo=%s, Inf_Contacto=%s, Sintesis=%s, Categoria=%s, Area=%s, Dpto=%s, edimar.FechaA=%s, departamento.FechaA=%s where personal.Cod=%s and departamento.Cod=Dpto and personal. Idioma=departamento.Idioma and edimar.Idioma=personal.Idioma",
 ...
 $query_reg_most = "SELECT personal.Cod, personal.Nombre, Apellido, Correo, Cargo, Dir_Foto, Inf_Contacto, Sintesis, Categoria, 
 ...
 $Dpto=$rowEdimar['Dpto']; $CodDpto=$rowEdimar['CodD'];  $Info=$rowEdimar['Inf_Contacto'];$Correo=$rowEdimar['Correo'];
}//del if isset
...
Nueva Esp.:</td>
                  ...
                  <tr>
                    <td height="40" align="left">Correo:</td>
                    <td height="40" align="left"><span class="Titulo_II">
                      <input name="Correo" type="text" id="Esp" value="<?php echo $Correo;?>">
                    </span></td>
                  </tr>
                  <tr>
