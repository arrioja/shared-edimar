...
$query_reg_most = "SELECT proyecto.Cod, proyecto.Titulo,Fase,Objetivos,Participantes,Descarga,linea_invest.Titulo as Linea,Permiso FROM proyecto  inner join linea_invest on linea_invest.Cod=linea and proyecto.Cod='".$_GET["Cod"]."'";
              ...
              <br>
                <table width="100%"  border="0" cellspacing="0" cellpadding="0" class="cuadro">
                  ...
                  <tr>
                    <td class="borde_SupI"><p class="Titulo_II">
                      <?php  if ((isset($_GET["Id"]))&& ($_GET["Id"]=='_Ing'))
			         { echo "Linea de Investigación";} 
			         else { echo "Linea de Investigación"; } ?>
                    </p></td>
                    <td class="borde_Sup"><p class="Parrafo_II"><?php echo  $rowEdimar['Linea']; ?></p></td>
                  </tr>
                  <tr>
                    <td class="borde_SupI"><p class="Titulo_II"><?php  if ((isset($_GET["Id"]))&& ($_GET["Id"]=='_Ing'))
