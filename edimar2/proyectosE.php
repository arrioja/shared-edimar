<?php include('conexion.php');
 ...
 $query_reg_most = "SELECT proyecto.Cod, Nombre as Dpto, departamento.Cod as CodDpto, Titulo FROM proyecto inner join
      ...
      <tr>
        ...
        <td width="74%" valign="top"><br><?php if (($rowPer['Permiso']==$permiso)||($rowPer['Permiso']=='0')||($permiso=='1')){?>
          <table width="98%"  border="0" cellspacing="0" cellpadding="0">
			...
			echo "Proyectos de Investigaci&oacute;n".$cad; } ?>        </td>
            </tr>
            <tr>
			  ...
			  $dpto=$rowEdimar["Dpto"];?>
                ...
                <td height="40" class="Borde_PunteadoII"><?php if ($rowEdimar["CodDpto"]==$usrD){?><A href="<?php echo "instProy.php?".$UR."&Id=".$_GET["Id"]."&Usr=".$usr."&NomD=". $rowEdimar["Dpto"]."&CodD=".$rowEdimar["CodDpto"]."&T=".$_GET["T"];?>"> <img border="0" src="Imagenes/nuevo.jpg" width="21" height="23"> A&ntilde;adir</A><?php }else{?>&nbsp;<?php }?></td>
			    </tr> <?php }?>
                <tr>
                  ...
                  <td height="45" class="borde_rayado"><?php if(($permiso=='1')||($rowEdimar["CodDpto"]==$usrD)){?>
                    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      <tr>
