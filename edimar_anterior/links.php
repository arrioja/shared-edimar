          ...
          <table width="98%"  border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
			  ...
			  while($rowEdimar = mysql_fetch_assoc($reg_most)){?>
                <tr>
                  <td width="80%" height="25" class="Borde_Punteado"><p class="Parrafo_II"><a target="_blank" href="<?php echo "http://".$rowEdimar["Link"]?>"><img border="0" name="imgLink" src="<?php echo "Imagenes/".$rowEdimar["Imagen"];?>" width="140" height="95" style="background-color: #FFFFFF"> 
                    <br> 
