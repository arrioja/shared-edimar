...
$id='';$usr='0'; $permiso=''; ; $Nick=''; $subtitulo=''; $tipo='';$err=0;
...
///////////////////////////////////////////captura el periso del usuario////////////////////////////////////////////////////////////
 if ((empty($_GET["Usr"]))||($_GET["Usr"]=='0')){  
  if ((!empty($_POST["nick"]))&&(!empty($_POST["pass"]))){
   $query="SELECT * FROM usuario where Nick='".$_POST["nick"]."' and Pass='".$_POST["pass"]."'";
 ...
 }else{$query="SELECT * FROM usuario where Cod='".$_GET["Usr"]."'";
   $reg_Usr=mysql_query($query, $conexion) or die(mysql_error());
   $rowUsr = mysql_fetch_assoc($reg_Usr); $usr=$rowUsr["Cod"]; $permiso=$rowUsr["Permiso"];$Nick=$rowUsr["Nick"];}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="74%" valign="top"><table width="98%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="center" class="Titulo"> <br> <?php  echo  $subtitulo; ?>
      </td>
          </tr>
          <tr>
            <td ><br>
                  ...
                  <tr>
					...
					<form name="forma" method="post" action="">
                      ...
                      <tr>
                        ...
                        <td colspan="2" align="left" ><input name="Ape" type="text" id="Ape"  value="<?php echo $Ape;?>">
                        </td>
                      </tr>
                      <tr>
