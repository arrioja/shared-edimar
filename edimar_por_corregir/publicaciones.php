			...
			<tr>
             ...
             <?php $dpto=''; $i=1;
			  ...
			  $dpto=$rowEdimar["Dpto"];?>
                ...
                <td height="40" colspan="3" class="Borde_PunteadoII"><p class="Titulo_II"><br><?php echo $rowEdimar["Dpto"];?></p>                  </td>
              </tr> <?php }?>
              <tr>
                ...
                <td width="6%" align="center" class="borde_rayado"><?php if($permiso=='1'){?>
                  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
