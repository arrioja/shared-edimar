              ...
              <table width="100%"  border="0" cellspacing="0" cellpadding="0" class="cuadro">
				 ...
				 <?php $i=1;
                  ...
                  <tr>
                    ...
                    <td width="11%" align="center" class="borde_Sup"><?php if ($regProyecto["Descarga"]!=''){?><a href=<?php echo "Proyectos/".$regProyecto["Descarga"]; ?>><img border="0" name=<?php echo "pdf".$i; ?> src="Imagenes/pdf.gif" width="35" height="33"></a><?php }else{?>&nbsp;<?php }?></td>
                  </tr>
				  <?php }?>
                </table>
